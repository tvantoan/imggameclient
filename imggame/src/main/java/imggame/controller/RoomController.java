...
import imggame.network.packets.ImageBufferResponse;
...
public class RoomController {
	...
	private void initialize() {
		...
		leftInviteBtn.setOnAction(e -> invitePlayer());
		rightInviteBtn.setOnAction(e -> invitePlayer());
	...
	private void invitePlayer() {
		...
		Platform.runLater(() -> {
			...
			alert.setTitle("Mời người chơi");
			alert.setHeaderText("Chức năng đang phát triển");
			alert.setContentText("Tính năng mời người chơi sẽ được bổ sung sau.");
			alert.show();
		});
	}
